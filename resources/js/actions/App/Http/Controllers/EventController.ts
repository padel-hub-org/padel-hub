...
*/
export const setDisabled = (args: { event: string | number | { id: string | number }, player: string | number | { id: string | number } } | [event: string | number | { id: string | number }, player: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/events/{event}/players/{player}/disabled'
*/
setDisabled.url = (args: { event: string | number | { id: string | number }, player: string | number | { id: string | number } } | [event: string | number | { id: string | number }, player: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            event: args[0],
            player: args[1],
...
* @route '/events/{event}/players/{player}/disabled'
*/
setDisabled.put = (args: { event: string | number | { id: string | number }, player: string | number | { id: string | number } } | [event: string | number | { id: string | number }, player: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: setDisabled.url(args, options),
    method: 'put',
})
