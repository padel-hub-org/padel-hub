...
* @see app/Http/Controllers/EventController.php:56
* @route '/events/{event}'
*/
...
* @see app/Http/Controllers/EventController.php:64
...
const EventController = { index, create, store, show, edit, update, destroy }
